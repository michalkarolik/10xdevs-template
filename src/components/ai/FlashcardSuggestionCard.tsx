...
import { Check, Edit, RefreshCw } from "lucide-react"; // Added CheckCircle
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-3 pt-0">
        {" "}
        {/* Removed top padding, adjusted spacing */}
        {suggestion.isEditing ? (
          ...
          <>
            ...
            <div className="border-l-4 border-primary pl-3 py-1">
              ...
              <p className="text-base whitespace-pre-wrap break-words">{suggestion.front}</p>
            </div>
            <div className="border-l-4 border-secondary pl-3 py-1">
              <h3 className="font-medium text-sm text-muted-foreground mb-1">Back</h3>
              <p className="text-base whitespace-pre-wrap break-words">{suggestion.back}</p>
            </div>
          </>
        )}
      </CardContent>
